 ...
 */
final class Version20190408232639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C16A2B381 FOREIGN KEY (book_id) REFERENCES book (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE bid ADD CONSTRAINT FK_4AF2B3F316A2B381 FOREIGN KEY (book_id) REFERENCES book (id) ON DELETE CASCADE');
